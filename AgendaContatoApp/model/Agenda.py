...
class Agenda():
    ...
    def listarContatos(self):
        ...
        if (self.contarContatos() == 0 ): # Verificando se a agenda possui algum contato salvo se não possuir exibir a mensagem de erro correspondente e encerrar o método
            print(semContatosSalvos)
        else: # Confirmado a existência de contatos na agenda prosseguir com o método
            print("==================================\n"
                  "CONTATOS SALVOS\n"
                  "==================================\n")
            ...
            if (nome.upper() == busca.upper()):
                ...
                while(True): # Loop de Erro caso o usuário digite um número invalido
                    ...
                    try:
                        ...
                        if op == 1:
                            del (self.contatos[cont]) # Deletando contato da lista atraves do index armazenado em cont
                            print("\nContato Excluido\n")
    ...
    def buscarContato(self,nome):
        ...
        encontrado = False # Variável que vai armazenar verdadeiro se o contato for encontrado ou falso se não for encontrado
